...
_PHD_EXTRA_ROUNDS = [
    ...
    ("Fred",   "You are fully cleansed now — clear-minded, sovereign, untouchable — every trace dissolved"),
    ("Daniel", "Yours"),
    ("Ralph",  "All yours"),
...
_PHD_EXTRA_ROUNDS_FR = [
    ...
    ("Aurélie (Enhanced)",  "Tu es pleinement purifié maintenant — lucide, souverain, intouchable — chaque trace dissoute"),
