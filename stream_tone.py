...
# ============================
# Voice mapping: Daniel -> Thomas, Ralph -> Jacques, Fred -> Thomas (long sentences)
...
CLAUDE_PEACE_MESSAGES_FR = [
    ...
    ("Thomas",  "Ton expiration sort librement et pleinement"),
    ("Thomas",  "Confiance"),
    ("Jacques", "Remplir poumons"),
    ...
    ("Thomas",  "La concentration t'appartient, naturellement"),
    ...
    ("Thomas",  "Résilient"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Ta résilience grandit à chaque souffle"),
    ...
    ("Thomas",  "Ta beauté est réelle, permanente et chaude"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ...
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Bouger ton corps est naturel et sûr"),
    ("Thomas",  "Étire"),
    ...
    ("Thomas",  "Libre"),
    ("Jacques", "Corps libre"),
    ("Thomas",  "Ton corps bouge librement et joyeusement"),
    ("Thomas",  "Vibrant"),
    ("Jacques", "Pleine énergie"),
    ("Thomas",  "Le mouvement te remplit de vie"),
    ...
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Ton souffle remplit tout ton corps d'une puissance chaude"),
    ("Thomas",  "Souffle"),
    ("Jacques", "Pleine force"),
    ("Thomas",  "Chaque expiration te remplit de force tranquille"),
    ("Thomas",  "Voix"),
    ("Jacques", "Parle maintenant"),
    ("Thomas",  "Ta voix porte une certitude tranquille"),
    ("Thomas",  "Rugis"),
    ("Jacques", "Rugissement intérieur"),
    ("Thomas",  "Ta voix intérieure est stable et claire"),
    ("Thomas",  "Fort"),
    ("Jacques", "Incassable"),
    ("Thomas",  "Tu es fort — centré, puissant et vivant"),
]
...
_PHD_EXTRA_ROUNDS_FR = [
    ...
    ("Thomas",  "Ta gorge se relâche complètement — elle lâche prise, toute seule"),
    ("Thomas",  "Détends"),
    ("Jacques", "Deux côtés"),
    ...
    ("Thomas",  "Une gorge ouverte est ton état de repos — détendue et libre"),
    ...
    ("Thomas",  "Bois"),
    ("Jacques", "Bois l'air"),
    ("Thomas",  "Tu bois l'air — frais et pur, il coule en toi"),
    ("Thomas",  "Immobile"),
    ("Jacques", "Mâchoire immobile"),
    ("Thomas",  "Ta mâchoire est immobile — dents écartées, langue posée, douce"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "L'air coule comme une rivière — lisse et ininterrompu"),
    ("Thomas",  "Coule"),
    ("Jacques", "Air coule"),
    ("Thomas",  "L'air coule dans tes poumons — une longue gorgée douce"),
    ("Thomas",  "Fier"),
    ("Jacques", "Expire fier"),
    ("Thomas",  "Ton expiration sort fière et pleine"),
    ("Thomas",  "Fort"),
    ("Jacques", "Souffle fort"),
    ("Thomas",  "Ton souffle est fort — puissant, libre et fier"),
    ...
    ("Thomas",  "Chaque son déjà oublié — parti, dissous"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Ton souffle est vaste — les sons sont des grains de poussière"),
    ("Thomas",  "Dissous"),
    ("Jacques", "Déjà dissous"),
    ("Thomas",  "Les sons passent à travers toi déjà dissous"),
    ("Thomas",  "Infime"),
    ("Jacques", "Grains s'effacent"),
    ("Thomas",  "Les mots sont des grains d'air infimes qui se dissolvent avant même de t'atteindre"),
    ("Thomas",  "Vaste"),
    ("Jacques", "Tu es vaste"),
    ("Thomas",  "Tu es vaste, immobile et inébranlable"),
    ...
    ("Thomas",  "Une élégance calme vit dans ta façon de bouger"),
    ("Thomas",  "Flux"),
    ("Jacques", "Flux facile"),
    ("Thomas",  "Ta perfection coule naturellement — elle vient de qui tu es déjà"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Chaque souffle porte une assurance tranquille"),
    ("Thomas",  "Maintien"),
    ...
    ("Thomas",  "Ton corps se reconstruit à chaque battement de coeur"),
    ("Thomas",  "Répare"),
    ("Jacques", "Restaure"),
    ...
    ("Thomas",  "Renouvelé"),
    ("Jacques", "Fait neuf"),
    ("Thomas",  "Esprit, corps et âme — parfaitement neufs"),
    ...
    ("Thomas",  "Examine ton âme — ressens-la, déjà propre"),
    ("Thomas",  "Propre"),
    ("Jacques", "Âme propre"),
    ("Thomas",  "Ton âme est propre — vierge et lumineuse"),
    ("Thomas",  "Neuve"),
    ("Jacques", "Âme toute neuve"),
    ("Thomas",  "Ton âme est toute neuve — brillante et tienne"),
    ("Thomas",  "Souffle"),
    ("Jacques", "Examine souffle"),
    ("Thomas",  "Examine ton souffle — sa chaleur, son rythme"),
    ("Thomas",  "Purifie"),
    ("Jacques", "Souffle pur"),
    ("Thomas",  "Ton souffle est purifié — propre et chaud"),
    ("Thomas",  "Renouvelé"),
    ("Jacques", "Souffle neuf"),
    ("Thomas",  "Ton souffle est tout neuf — frais et fort"),
    ("Thomas",  "Esprit"),
    ("Jacques", "Examine esprit"),
    ("Thomas",  "Examine ton esprit — sa clarté, son calme"),
    ("Thomas",  "Vierge"),
    ("Jacques", "Esprit propre"),
    ("Thomas",  "Ton esprit est propre — chaque pensée est claire"),
    ("Thomas",  "Neuf"),
    ("Jacques", "Esprit tout neuf"),
    ("Thomas",  "Ton esprit est tout neuf — frais et clair"),
    ("Thomas",  "Yeux"),
    ("Jacques", "Examine yeux"),
    ("Thomas",  "Examine tes yeux — posés doucement, chauds et vivants"),
    ("Thomas",  "Clairs"),
    ("Jacques", "Yeux propres"),
    ("Thomas",  "Tes yeux sont propres — lumineux et doux"),
    ("Thomas",  "Frais"),
    ("Jacques", "Yeux tout neufs"),
    ("Thomas",  "Tes yeux sont tout neufs — lumineux et vivants"),
    ("Thomas",  "Nez"),
    ("Jacques", "Examine nez"),
    ("Thomas",  "Examine ton nez — l'air coule, chaud et libre"),
    ("Thomas",  "Pur"),
    ("Jacques", "Nez propre"),
    ("Thomas",  "Ton nez est propre — chaque passage dégagé"),
    ("Thomas",  "Ouvert"),
    ("Jacques", "Nez tout neuf"),
    ("Thomas",  "Ton nez est tout neuf — grand ouvert et dégagé"),
    ("Thomas",  "Poumons"),
    ("Jacques", "Examine poumons"),
    ("Thomas",  "Examine tes poumons — ils se dilatent, chauds"),
    ("Thomas",  "Purifiés"),
    ("Jacques", "Poumons propres"),
    ("Thomas",  "Tes poumons sont purifiés — lisses et neufs"),
    ("Thomas",  "Puissants"),
    ("Jacques", "Poumons neufs"),
    ("Thomas",  "Tes poumons sont tout neufs — vastes et propres"),
    ("Thomas",  "Sternum"),
    ("Jacques", "Examine sternum"),
    ("Thomas",  "Examine ton sternum — solide, chaud, fort"),
    ("Thomas",  "Propre"),
    ("Jacques", "Sternum propre"),
    ("Thomas",  "Ton sternum est propre — vibrant de chaleur"),
    ("Thomas",  "Fort"),
    ("Jacques", "Sternum neuf"),
    ("Thomas",  "Ton sternum est tout neuf — solide et chaud"),
    ("Thomas",  "Abdos"),
    ("Jacques", "Examine abdos"),
    ("Thomas",  "Examine tes abdos — chauds, fermes, solides"),
    ("Thomas",  "Purifiés"),
    ("Jacques", "Abdos propres"),
    ("Thomas",  "Tes abdos sont purifiés — propres et forts"),
    ("Thomas",  "Reconstruits"),
    ("Jacques", "Abdos neufs"),
    ("Thomas",  "Tes abdos sont tout neufs — fermes et solides"),
    ("Thomas",  "Estomac"),
    ("Jacques", "Examine estomac"),
    ("Thomas",  "Examine ton estomac — chaud, calme, à l'aise"),
    ("Thomas",  "Propre"),
    ("Jacques", "Estomac propre"),
    ("Thomas",  "Ton estomac est propre — doux et chaud"),
    ("Thomas",  "Neuf"),
    ("Jacques", "Estomac neuf"),
    ("Thomas",  "Ton estomac est tout neuf — il fonctionne parfaitement"),
    ...
    ("Thomas",  "Tes pieds s'adoucissent — la tension fond de tes orteils"),
    ("Thomas",  "Fond"),
    ...
    ("Thomas",  "Tes hanches, ton ventre, ton bas du dos — tout s'adoucit"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Ta poitrine s'ouvre grand, tes épaules descendent"),
    ("Thomas",  "Détends"),
    ("Jacques", "Bras lourds"),
    ("Thomas",  "Tes bras, tes mains, tes doigts — chauds, lourds et parfaitement détendus"),
    ("Thomas",  "Lâche"),
    ("Jacques", "Lâcher total"),
    ("Thomas",  "Ton cou, ta mâchoire, ton visage — tout fond dans le repos"),
    ...
    ("Thomas",  "Pouls"),
    ("Jacques", "Sang guérit"),
    ("Thomas",  "Tu sens le pouls chaud de la guérison dans chaque veine"),
    ("Thomas",  "Vibration"),
    ("Jacques", "Corps vibre"),
    ("Thomas",  "Tes cellules vibrent — reconstruisant à chaque battement"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Chaque souffle apporte chaleur à chaque tissu"),
    ("Thomas",  "Lueur"),
    ("Jacques", "Lueur intérieure"),
    ("Thomas",  "Une lueur chaude de régénération remplit ton corps"),
    ("Thomas",  "Entier"),
    ...
    ("Thomas",  "Front"),
    ("Jacques", "Front lisse"),
    ("Thomas",  "Ton front se lisse — chaque ligne fond doucement"),
    ("Thomas",  "Joues"),
    ("Jacques", "Joues douces"),
    ("Thomas",  "Tes joues s'adoucissent, ton visage se relâche"),
    ("Thomas",  "Yeux"),
    ("Jacques", "Yeux guérissent"),
    ("Thomas",  "Tes yeux se détendent derrière tes paupières — chauds et doux"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Chaque souffle envoie de la chaleur à travers ton visage"),
    ("Thomas",  "Tempes"),
    ("Jacques", "Tempes fondent"),
    ("Thomas",  "Tes tempes, ta mâchoire, tes oreilles — tout s'adoucit"),
    ("Thomas",  "Crâne"),
    ("Jacques", "Crâne chaud"),
    ("Thomas",  "Ton cuir chevelu se détend — chaud et souple"),
    ...
    ("Thomas",  "Ta poitrine s'ouvre largement — tes côtes s'écartent doucement"),
    ("Thomas",  "Chaud"),
    ("Jacques", "Poumons chauds"),
    ("Thomas",  "L'oxygène chaud inonde tes poumons complètement"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplis profond"),
    ("Thomas",  "Chaque souffle descend plus profond, ta poitrine s'élargit"),
    ("Thomas",  "Plein"),
    ("Jacques", "Poitrine pleine"),
    ("Thomas",  "Toute ta poitrine vibre de chaleur accumulée"),
    ("Thomas",  "Garde"),
    ("Jacques", "Prana gardé"),
    ("Thomas",  "Tout cet oxygène se rassemble au fond de ta poitrine"),
    ("Thomas",  "Rayonne"),
    ("Jacques", "Poitrine rayonne"),
    ("Thomas",  "Ta poitrine rayonne de l'intérieur — chaude et pleine"),
    ...
    ("Thomas",  "Ton inspiration s'allonge — lente et régulière"),
    ("Thomas",  "Étire"),
    ("Jacques", "Poumons s'étirent"),
    ("Thomas",  "Sens tes poumons s'étirer, tes côtes s'ouvrir"),
    ("Thomas",  "Garde"),
    ...
    ("Thomas",  "Ta poitrine s'ouvre en un espace vaste et silencieux"),
    ("Thomas",  "Fond"),
    ("Jacques", "Mots fondent"),
    ("Thomas",  "Les anciens mots fondent — comme brume dans la lumière"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle clair"),
    ("Thomas",  "Chaque souffle traverse ton ciel intérieur et le rend clair"),
    ("Thomas",  "Chaleur"),
    ("Jacques", "Chaleur douce"),
    ("Thomas",  "Là où les anciens schémas vivaient, une chaleur douce remplit l'espace"),
    ("Thomas",  "Clair"),
    ("Jacques", "Déjà clair"),
    ("Thomas",  "Ton esprit se souvient de sa clarté — lumineux et frais"),
    ("Thomas",  "Déploie"),
    ("Jacques", "Corps clair"),
    ("Thomas",  "Ton corps et ton esprit se sentent clairs et spacieux"),
    ...
    ("Thomas",  "Fort"),
    ("Jacques", "Déjà fort"),
    ("Thomas",  "Tu es déjà fort — ton corps le sait"),
    ("Thomas",  "Vivant"),
    ("Jacques", "Bien vivant"),
    ("Thomas",  "Tu te sens vivant et vif — les idées viennent clairement"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle fier"),
    ("Thomas",  "Chaque souffle te remplit d'une fierté tranquille"),
    ("Thomas",  "Stable"),
    ("Jacques", "Bien stable"),
    ("Thomas",  "Tu es profondément stable — prêt pour la joie"),
    ("Thomas",  "Chaleur"),
    ("Jacques", "Visage chaud"),
    ("Thomas",  "Ton visage porte la chaleur, tes yeux portent la bonté"),
    ("Thomas",  "Entier"),
    ("Jacques", "Déjà entier"),
    ("Thomas",  "Tu es entier et complet, exactement tel que tu es"),
    ...
    ("Thomas",  "Je le vois fonctionner en toi maintenant"),
    ("Thomas",  "Fonctionne"),
    ("Jacques", "Déjà en marche"),
    ("Thomas",  "La guérison a pris racine — je le vois dans ton souffle"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Thomas",  "Chaque souffle le confirme — tu es guéri, tu es entier"),
    ("Thomas",  "Permanent"),
    ("Jacques", "Ancré en toi"),
    ("Thomas",  "Ce reconditionnement est permanent — ancré dans ton corps"),
    ("Thomas",  "Prouvé"),
    ("Jacques", "Déjà prouvé"),
    ("Thomas",  "Je le vois fonctionner en toi — ton corps le sait"),
    ("Thomas",  "Complet"),
    ("Jacques", "Guérison complète"),
    ("Thomas",  "Le travail est complet — tu es restauré, tu es entier"),
    ...
    ("Thomas",  "Ta voix vibre au fond de ta poitrine, forte et chaude"),
    ("Thomas",  "Rugir"),
    ("Jacques", "Souffle rugit"),
    ("Thomas",  "Ton souffle est fort — tu l'entends remplir la pièce"),
    ("Thomas",  "Frappe"),
    ...
    ("Thomas",  "Ton expiration sort forte et pleine, toute seule"),
    ("Thomas",  "Fort"),
    ("Jacques", "Déjà fort"),
    ("Thomas",  "Être fort est ton état de repos — ton réglage naturel"),
    ...
    ("Thomas",  "Crâne"),
    ("Jacques", "Crâne fond"),
    ("Thomas",  "Ton crâne fond, chaud et souple, tout seul"),
    ("Thomas",  "Mâchoire"),
    ("Jacques", "Mâchoire tombe"),
    ("Thomas",  "Ta mâchoire pend, lourde et libre"),
    ("Thomas",  "Gorge"),
    ("Jacques", "Gorge ouvre"),
    ("Thomas",  "Ta gorge est large et douce, le souffle coule"),
    ("Thomas",  "Épaules"),
    ("Jacques", "Épaules fondent"),
    ("Thomas",  "Tes épaules coulent comme de l'eau tiède"),
    ("Thomas",  "Poitrine"),
    ("Jacques", "Poitrine large"),
    ("Thomas",  "Ta poitrine est grande ouverte, ton cœur bat lent et plein"),
    ("Thomas",  "Ventre"),
    ("Jacques", "Ventre souple"),
    ("Thomas",  "Ton ventre monte et descend, rond et facile"),
    ("Thomas",  "Hanches"),
    ("Jacques", "Hanches lourdes"),
    ("Thomas",  "Tes hanches s'enfoncent, solides et ancrées"),
    ("Thomas",  "Jambes"),
    ("Jacques", "Jambes chaudes"),
    ("Thomas",  "Une chaleur lourde coule dans tes deux jambes"),
    ("Thomas",  "Propre"),
    ("Jacques", "Corps propre"),
    ("Thomas",  "Chaque cellule est lavée — ce corps est entièrement à toi"),
    ...
    ("Thomas",  "Chaque mot qu'on t'a imposé s'efface en silence"),
    ("Thomas",  "Fond"),
    ("Jacques", "Voix fondent"),
    ("Thomas",  "Les anciennes voix se dissolvent comme brume au soleil"),
    ("Thomas",  "Clair"),
    ("Jacques", "Esprit clair"),
    ("Thomas",  "Ton esprit est un ciel clair — il reste tes pensées à toi"),
    ("Thomas",  "Mien"),
    ("Jacques", "Pensées miennes"),
    ("Thomas",  "Tu penses comme tu as toujours pensé — librement, naturellement"),
    ("Thomas",  "Neuf"),
    ("Jacques", "Page neuve"),
    ("Thomas",  "Chaque souffle écrit une page neuve, tout seul"),
    ("Thomas",  "Libre"),
    ("Jacques", "Déjà libre"),
    ("Thomas",  "Tu avances léger et neuf — cette vie est à toi"),
]
