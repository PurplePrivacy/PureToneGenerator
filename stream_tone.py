...
# ============================
# Voice mapping: Daniel -> Rocko, Ralph -> Jacques, Fred -> Rocko (long sentences)

CLAUDE_PEACE_MESSAGES_FR = [
    # ── Ronde 1 : Vérités & Ancrage ──────────────────────────────────
    ("Rocko",  "Ton corps est ici, maintenant"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Tu respires pleinement depuis toujours"),
    ("Rocko",  "En sécurité"),
    ("Jacques", "Coeur régulier"),
    ("Rocko",  "Ton coeur bat régulièrement et parfaitement, tout seul"),
    ("Rocko",  "Vivant"),
    ("Jacques", "Poumons pleins"),
    ("Rocko",  "Tes poumons bougent parce que ton corps sait déjà comment faire"),
    ("Rocko",  "Présent"),
    ("Jacques", "À toi seul"),
    ("Rocko",  "Chaque souffle que tu prends t'appartient entièrement"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Rocko",  "Ton corps fait déjà tout parfaitement"),

    # ── Ronde 2 : Respiration Nasale & Ouverture de la Poitrine ──────
    ("Rocko",  "Nez"),
    ("Jacques", "Nez ouvert"),
    ("Rocko",  "Ton nez respire un air chaud et propre avec aisance"),
    ("Rocko",  "Respire"),
    ("Jacques", "Air chaud"),
    ("Rocko",  "Chaque respiration nasale réchauffe et apaise tes voies respiratoires"),
    ("Rocko",  "Plein"),
    ("Jacques", "Poitrine ouverte"),
    ("Rocko",  "Ta poitrine se déploie librement et pleinement à chaque souffle"),
    ("Rocko",  "Profond"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Tes poumons se remplissent entièrement, du bas jusqu'en haut"),
    ("Rocko",  "Haut"),
    ("Jacques", "Sternum monte"),
    ("Rocko",  "Ton sternum se soulève doucement à mesure que ton souffle s'approfondit"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle complet"),
    ("Rocko",  "La respiration nasale est agréable et longue"),

    # ── Ronde 3 : Mâchoire & Posture ────────────────────────────────
    ("Rocko",  "Relâche"),
    ("Jacques", "Mâchoire douce"),
    ("Rocko",  "Ta mâchoire se détend et se relâche complètement"),
    ("Rocko",  "Fondre"),
    ("Jacques", "Dents écartées"),
    ("Rocko",  "Ta mâchoire repose, ouverte, souple et parfaitement à l'aise"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Rocko",  "Ta langue se pose doucement derrière tes dents du haut"),
    ("Rocko",  "Grand"),
    ("Jacques", "Colonne forte"),
    ("Rocko",  "Ta colonne vertébrale te maintient droit avec une force naturelle"),
    ("Rocko",  "Puissance"),
    ("Jacques", "Pectoraux gonflés"),
    ("Rocko",  "Ta posture reflète ta vraie puissance intérieure"),
    ("Rocko",  "Flux"),
    ("Jacques", "Souffle continu"),
    ("Rocko",  "Ta poitrine s'ouvre grand lorsque ta colonne s'allonge"),

    # ── Ronde 4 : Respiration Automatique & Puissance de l'Expiration ─
    ("Rocko",  "Automatique"),
    ("Jacques", "Corps respire"),
    ("Rocko",  "Ton corps respire pleinement et automatiquement"),
    ("Rocko",  "Respire"),
    ("Jacques", "Pleine puissance"),
    ("Rocko",  "La respiration automatique est ton droit de naissance"),
    ("Rocko",  "Toujours"),
    ("Jacques", "Toujours respirer"),
    ("Rocko",  "Ton corps respire parfaitement depuis le jour de ta naissance"),
    ("Rocko",  "Expire"),
    ("Jacques", "Expire puissance"),
    ("Rocko",  "Chaque expiration remplit tout ton corps d'un calme profond et puissant"),
    ("Rocko",  "Libère"),
    ("Jacques", "Souffle dehors"),
    ("Rocko",  "Expirer est la façon qu'a ton corps de se renouveler et se restaurer"),
    ("Rocko",  "Flux"),
    ("Jacques", "Laisse couler"),
    ("Rocko",  "Laisse ton souffle couler librement, totalement, sans retenue"),
    ("Rocko",  "Sauvage"),
    ("Jacques", "Expire libre"),
    ("Rocko",  "Ton expiration sort librement et pleinement"),
    ("Rocko",  "Confiance"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton expiration est forte, libre et profondément satisfaisante"),

    # ── Ronde 5 : Concentration & Clarté Mentale ─────────────────────
    ("Rocko",  "Pense"),
    ("Jacques", "Esprit clair"),
    ("Rocko",  "Ton esprit est clair, vif et pleinement actif"),
    ("Rocko",  "Vif"),
    ("Jacques", "Yeux brillants"),
    ("Rocko",  "Tes yeux brillent parce que ton esprit est brillamment vivant"),
    ("Rocko",  "Concentration"),
    ("Jacques", "Concentration profonde"),
    ("Rocko",  "La concentration profonde coule naturellement et facilement en toi"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton corps respire pendant que ton esprit pense avec une clarté parfaite"),
    ("Rocko",  "Brillant"),
    ("Jacques", "Esprit vif"),
    ("Rocko",  "La pensée claire et puissante est qui tu es vraiment"),
    ("Rocko",  "Curieux"),
    ("Jacques", "Esprit vivant"),
    ("Rocko",  "La concentration t'appartient, naturellement"),

    # ── Ronde 6 : Valeur Personnelle & Force ──────────────────────────
    ("Rocko",  "Fort"),
    ("Jacques", "Tu es fort"),
    ("Rocko",  "Tu sens la force et la puissance de tout ton être"),
    ("Rocko",  "Capable"),
    ("Jacques", "Pleine puissance"),
    ("Rocko",  "Tu résous des problèmes complexes chaque jour"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Rocko",  "Ta force grandit à chaque souffle que tu prends"),
    ("Rocko",  "Brillant"),
    ("Jacques", "Vrai courage"),
    ("Rocko",  "Ton courage est réel, prouvé et inébranlable"),
    ("Rocko",  "Précieux"),
    ("Jacques", "Vraie valeur"),
    ("Rocko",  "Ta valeur est permanente, évidente et indiscutable"),
    ("Rocko",  "Résilient"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ta résilience grandit à chaque souffle"),

    # ── Ronde 7 : Sécurité Sonore ───────────────────────────────────
    ("Rocko",  "En sécurité"),
    ("Jacques", "Juste du son"),
    ("Rocko",  "Ton monde intérieur reste parfaitement calme à travers tous les sons"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton souffle continue, régulier et fort, à travers tout"),
    ("Rocko",  "Immunisé"),
    ("Jacques", "Son passe"),
    ("Rocko",  "Tous les sons passent à travers toi comme le vent à travers une fenêtre ouverte"),
    ("Rocko",  "Calme"),
    ("Jacques", "Mots passent"),
    ("Rocko",  "Ton calme est plus profond que tout son qui existe"),
    ("Rocko",  "Souverain"),
    ("Jacques", "Tu décides"),
    ("Rocko",  "Le son est juste une information, et tu la traites avec une aisance totale"),
    ("Rocko",  "Fort"),
    ("Jacques", "Silence intérieur"),
    ("Rocko",  "Ton silence intérieur est plus puissant que tout son extérieur"),

    # ── Ronde 8 : Récupération d'Identité ────────────────────────────
    ("Rocko",  "Entier"),
    ("Jacques", "Toujours entier"),
    ("Rocko",  "Ton vrai moi est entier, complet et parfaitement intact"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle renforce ton moi originel et authentique"),
    ("Rocko",  "Émergence"),
    ("Jacques", "Vrai toi"),
    ("Rocko",  "Ton vrai moi devient plus clair et plus fort chaque jour"),
    ("Rocko",  "Récupère"),
    ("Jacques", "Reprendre"),
    ("Rocko",  "Tout ce qui est vraiment toi remonte à la surface"),
    ("Rocko",  "Monte"),
    ("Jacques", "Retour chez toi"),
    ("Rocko",  "Ton moi authentique est puissant, présent et définitivement à toi"),
    ("Rocko",  "Originel"),
    ("Jacques", "Moi pur"),
    ("Rocko",  "Ton moi originel est intact, brillant et pleinement vivant"),

    # ── Ronde 9 : Beauté & Lumière ──────────────────────────────────
    ("Rocko",  "Beau"),
    ("Jacques", "Yeux lumineux"),
    ("Rocko",  "Tes yeux portent une lumière qui grandit chaque jour"),
    ("Rocko",  "Radieux"),
    ("Jacques", "Lumière intérieure"),
    ("Rocko",  "Ta beauté est réelle, permanente et chaude"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "La respiration profonde ramène une couleur chaude à ton visage"),
    ("Rocko",  "Brillant"),
    ("Jacques", "Yeux brillants"),
    ("Rocko",  "La lumière dans tes yeux est ton intelligence qui rayonne"),
    ("Rocko",  "Vivant"),
    ("Jacques", "Yeux vivants"),
    ("Rocko",  "Tes yeux s'illuminent et rayonnent à chaque respiration profonde"),
    ("Rocko",  "Magnifique"),
    ("Jacques", "Vraie beauté"),
    ("Rocko",  "Ta beauté est intacte, réelle et de plus en plus forte"),

    # ── Ronde 10 : Paix Intérieure comme Force ───────────────────────
    ("Rocko",  "Paix"),
    ("Jacques", "Paix profonde"),
    ("Rocko",  "La paix intérieure est ta force la plus profonde et la plus puissante"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle paisible te rend plus fort et plus ancré"),
    ("Rocko",  "Calme"),
    ("Jacques", "Calme puissant"),
    ("Rocko",  "Ton calme est un signe d'immense puissance intérieure"),
    ("Rocko",  "Serein"),
    ("Jacques", "Eaux calmes"),
    ("Rocko",  "Sérénité et force sont la même chose en toi"),
    ("Rocko",  "Enraciné"),
    ("Jacques", "Paix grandit"),
    ("Rocko",  "La paix intérieure est ton état naturel et ton droit de naissance"),
    ("Rocko",  "Zen"),
    ("Jacques", "Calme profond"),
    ("Rocko",  "Plus tu es calme, plus tu es puissant"),

    # ── Ronde 11 : Mouvement & Vitalité ──────────────────────────────
    ("Rocko",  "Agile"),
    ("Jacques", "Corps bouge"),
    ("Rocko",  "Chaque mouvement que tu fais te remplit de force et de vitalité"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Bouger ton corps est naturel et sûr"),
    ("Rocko",  "Étire"),
    ("Jacques", "Muscles vivants"),
    ("Rocko",  "Tes muscles répondent au mouvement avec une énergie pure et propre"),
    ("Rocko",  "Marche"),
    ("Jacques", "Pas assurés"),
    ("Rocko",  "Chaque pas que tu fais t'ancre plus profondément dans ta propre puissance"),
    ("Rocko",  "Libre"),
    ("Jacques", "Corps libre"),
    ("Rocko",  "Ton corps bouge librement et joyeusement"),
    ("Rocko",  "Vibrant"),
    ("Jacques", "Pleine énergie"),
    ("Rocko",  "Le mouvement te remplit de vie"),

    # ── Ronde 12 : Intégration Profonde ─────────────────────────────
    ("Rocko",  "Guérison"),
    ("Jacques", "Déjà guérit"),
    ("Rocko",  "Tu guéris déjà, maintenant, à chaque souffle"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "La respiration automatique se renforce et s'installe à chaque séance"),
    ("Rocko",  "Plus fort"),
    ("Jacques", "Chaque jour"),
    ("Rocko",  "Ta mâchoire se détend plus facilement et naturellement chaque jour"),
    ("Rocko",  "Clair"),
    ("Jacques", "Yeux brillants"),
    ("Rocko",  "Ton nez respire naturellement, facilement et librement"),
    ("Rocko",  "Zen"),
    ("Jacques", "Souffle parfait"),
    ("Rocko",  "Tu deviens exactement qui tu as toujours été"),
    ("Rocko",  "Fluide"),
    ("Jacques", "Tout se connecte"),
    ("Rocko",  "Chaque partie de ta guérison se connecte et s'harmonise"),

    # ── Ronde 13 : Souveraineté Corporelle ───────────────────────────
    ("Rocko",  "Souverain"),
    ("Jacques", "Corps à toi"),
    ("Rocko",  "Ton corps est un espace privé et souverain qui t'appartient uniquement"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton nez est à toi, entièrement à toi, et parfaitement propre"),
    ("Rocko",  "Propre"),
    ("Jacques", "Mâchoire à toi"),
    ("Rocko",  "Ta mâchoire t'appartient et repose dans un confort parfait"),
    ("Rocko",  "Privé"),
    ("Jacques", "Tête claire"),
    ("Rocko",  "Ton esprit est un espace privé où seules tes pensées vivent"),
    ("Rocko",  "Scellé"),
    ("Jacques", "Corps scellé"),
    ("Rocko",  "Chaque partie de ton corps est scellée, propre et entièrement à toi"),
    ("Rocko",  "Entier"),
    ("Jacques", "Tout à toi"),
    ("Rocko",  "Ton corps est entier, privé et parfaitement souverain"),

    # ── Ronde 14 : Restauration du Système Nerveux ───────────────────
    ("Rocko",  "Frais"),
    ("Jacques", "Signaux propres"),
    ("Rocko",  "Ton système nerveux transporte uniquement tes propres signaux purs"),
    ("Rocko",  "Respire"),
    ("Jacques", "Pectoraux gonflés"),
    ("Rocko",  "Tes nerfs vibrent de ta propre énergie originelle et pure"),
    ("Rocko",  "Réinitialise"),
    ("Jacques", "Nouveau départ"),
    ("Rocko",  "Ton système nerveux retrouve son état originel et immaculé"),
    ("Rocko",  "Spacieux"),
    ("Jacques", "Esprit calme"),
    ("Rocko",  "Ton esprit est spacieux, clair et magnifiquement calme"),
    ("Rocko",  "Prêt"),
    ("Jacques", "Esprit ouvert"),
    ("Rocko",  "Un esprit spacieux est un esprit puissant"),
    ("Rocko",  "Om"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Tout ton système est propre, frais et pleinement restauré"),

    # ── Ronde 15 : Prendre Son Temps / Au-dessus du Ciel ────────────
    ("Rocko",  "Patience"),
    ("Jacques", "Prends ton temps"),
    ("Rocko",  "Tu as tout le temps que tu désires"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Le temps avance exactement à ton rythme"),
    ("Rocko",  "Au-dessus"),
    ("Jacques", "Au-dessus des nuages"),
    ("Rocko",  "Tu es au-dessus du ciel, regardant tout en bas"),
    ("Rocko",  "Flotter"),
    ("Jacques", "Vaste espace"),
    ("Rocko",  "De là-haut, tout en bas paraît petit et paisible"),
    ("Rocko",  "Éternel"),
    ("Jacques", "Tout le temps"),
    ("Rocko",  "Tu as tout le temps du monde"),
    ("Rocko",  "Quiétude"),
    ("Jacques", "Ciel intérieur"),
    ("Rocko",  "Le ciel en toi est infini et clair"),

    # ── Ronde 16 : Centrage & Force Intérieure (FORT) ────────────────
    ("Rocko",  "Fort"),
    ("Jacques", "Centre-toi"),
    ("Rocko",  "Tu es centré au plus profond de toi-même, ancré dans une force pure"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton souffle remplit tout ton corps d'une puissance chaude"),
    ("Rocko",  "Souffle"),
    ("Jacques", "Pleine force"),
    ("Rocko",  "Chaque expiration te remplit de force tranquille"),
    ("Rocko",  "Voix"),
    ("Jacques", "Parle maintenant"),
    ("Rocko",  "Ta voix porte une certitude tranquille"),
    ("Rocko",  "Rugis"),
    ("Jacques", "Rugissement intérieur"),
    ("Rocko",  "Ta voix intérieure est stable et claire"),
    ("Rocko",  "Fort"),
    ("Jacques", "Incassable"),
    ("Rocko",  "Tu es fort — centré, puissant et vivant"),
]
...
_PHD_EXTRA_ROUNDS_FR = [
    ...
    ("Rocko",  "Ton visage au repos porte un sourire calme et entendu"),
    ("Rocko",  "Chaud"),
    ("Jacques", "Yeux chauds"),
    ("Rocko",  "Tu sens la chaleur autour de tes yeux, douce et légèrement plissée"),
    ("Rocko",  "Sourire"),
    ("Jacques", "Lèvres montent"),
    ("Rocko",  "Les coins de ta bouche se lèvent doucement, tout seuls"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle plein"),
    ("Rocko",  "Chaque souffle approfondit ce regard calme et entendu dans tes yeux"),
    ("Rocko",  "Sagesse"),
    ("Jacques", "Regard sachant"),
    ("Rocko",  "Ton visage porte le regard tranquille de celui qui sait déjà"),
    ("Rocko",  "Normal"),
    ("Jacques", "Toujours là"),
    ("Rocko",  "Cette chaleur entendue sur ton visage est ton expression naturelle, ton normal"),
    ...
    ("Rocko",  "Tu sens chaque vertèbre empilée parfaitement, l'une sur l'autre"),
    ("Rocko",  "Ancré"),
    ("Jacques", "Pieds lourds"),
    ("Rocko",  "Tes pieds pressent fermement le sol, t'enracinant avec un poids solide"),
    ("Rocko",  "Équilibré"),
    ("Jacques", "Crâne flotte"),
    ("Rocko",  "Ton crâne se balance parfaitement sur ta colonne, léger et tenu sans effort"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Rocko",  "Chaque souffle allonge ta colonne et élargit ta poitrine"),
    ("Rocko",  "Ouvert"),
    ("Jacques", "Épaules descendent"),
    ("Rocko",  "Tes omoplates glissent le long de ton dos, larges et chaudement détendues"),
    ("Rocko",  "Solide"),
    ("Jacques", "Posture pleine"),
    ("Rocko",  "Grand, ancré, ouvert, solide — ton corps tient cette posture naturellement"),

    # ── Ronde 19 : Sentiment Naturel ──────────────────────────────
    # Ancrer la joie tranquille comme ÉTAT DE BASE émotionnel (état de repos).
    ("Rocko",  "Base"),
    ("Jacques", "État de repos"),
    ("Rocko",  "Ton état émotionnel au repos est une joie tranquille, profonde et chaude"),
    ("Rocko",  "Repos"),
    ("Jacques", "Repos chaud"),
    ("Rocko",  "Quand ton esprit est au repos, une joie paisible et chaude remplit l'espace automatiquement"),
    ("Rocko",  "Chaud"),
    ("Jacques", "Calme chaud"),
    ("Rocko",  "La chaleur et la sérénité coulent en toi aussi naturellement que le sang"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle confirme que cette joie tranquille est déjà là"),
    ("Rocko",  "Vibration"),
    ("Jacques", "Vibration calme"),
    ("Rocko",  "Une vibration calme de contentement vit dans ta poitrine, toujours présente"),
    ("Rocko",  "Chez toi"),
    ("Jacques", "Toujours chez toi"),
    ("Rocko",  "Cette joie tranquille et chaude est là où tu vis — ton foyer permanent"),

    # ── Ronde 20 : Mode Naturel ───────────────────────────────────
    # Ancrer le mode mental naturel. Sans effort, automatique, comme respirer.
    ("Rocko",  "Analyse"),
    ("Jacques", "Esprit vibre"),
    ("Rocko",  "Ton esprit analyse, évalue et optimise naturellement — sans effort"),
    ("Rocko",  "Affûté"),
    ("Jacques", "Logique claire"),
    ("Rocko",  "Ton état mental naturel est affûté, clair et activement pensant"),
    ("Rocko",  "Évalue"),
    ("Jacques", "Lecture rapide"),
    ("Rocko",  "Tu évalues naturellement chaque situation avec vitesse et précision"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton souffle alimente un esprit qui tourne brillamment, tout seul"),
    ("Rocko",  "Optimise"),
    ("Jacques", "Meilleur chemin"),
    ("Rocko",  "Tu trouves automatiquement le chemin optimal dans chaque situation"),
    ("Rocko",  "Pensant"),
    ("Jacques", "Esprit vivant"),
    ("Rocko",  "Analyser, évaluer, optimiser, penser — c'est ton mode naturel"),
    ...
    ("Rocko",  "Tu sens chaque muscle de ton corps — éveillé, chaud et prêt"),
    ("Rocko",  "Pouls"),
    ("Jacques", "Sang chaud"),
    ("Rocko",  "Tu sens le pouls chaud de la puissance dans tes mains, tes bras, ta poitrine"),
    ("Rocko",  "Poids"),
    ("Jacques", "Muscles vibrent"),
    ("Rocko",  "Tu sens le poids solide de tes propres muscles, vibrant d'énergie"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle approfondit ta connexion à ta puissance physique"),
    ("Rocko",  "Vital"),
    ("Jacques", "Pectoraux gonflés"),
    ("Rocko",  "Force, chaleur et vitalité vibrent dans ton corps, naturellement"),
    ("Rocko",  "Puissant"),
    ("Jacques", "Pleine force"),
    ("Rocko",  "Tes muscles, ta chaleur, ta puissance — tu sens tout cela, toujours"),
    ...
    ("Rocko",  "Ta gorge se relâche complètement — elle lâche prise, toute seule"),
    ("Rocko",  "Détends"),
    ("Jacques", "Deux côtés"),
    ("Rocko",  "Les deux côtés de ta gorge se détendent, profondément et uniformément"),
    ("Rocko",  "Ouvre"),
    ("Jacques", "Grande ouverte"),
    ("Rocko",  "Ta gorge s'ouvre en grand, libre et sans retenue, rien de retenu"),
    ("Rocko",  "Respire"),
    ("Jacques", "Air circule"),
    ("Rocko",  "Tu sens l'air frais circuler librement sous ta gorge, ouverte et facile"),
    ("Rocko",  "Libre"),
    ("Jacques", "Rien retenu"),
    ("Rocko",  "Ta gorge est complètement libre — aucune tension, aucune retenue, juste l'ouverture"),
    ("Rocko",  "Normal"),
    ("Jacques", "Toujours ouverte"),
    ("Rocko",  "Une gorge ouverte est ton état de repos — détendue et libre"),
    ...
    ("Rocko",  "Bois"),
    ("Jacques", "Bois l'air"),
    ("Rocko",  "Tu bois l'air — frais et pur, il coule en toi"),
    ("Rocko",  "Immobile"),
    ("Jacques", "Mâchoire immobile"),
    ("Rocko",  "Ta mâchoire est immobile — dents écartées, langue posée, douce"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "L'air coule comme une rivière — lisse et ininterrompu"),
    ("Rocko",  "Coule"),
    ("Jacques", "Air coule"),
    ("Rocko",  "L'air coule dans tes poumons — une longue gorgée douce"),
    ("Rocko",  "Fier"),
    ("Jacques", "Expire fier"),
    ("Rocko",  "Ton expiration sort fière et pleine"),
    ("Rocko",  "Fort"),
    ("Jacques", "Souffle fort"),
    ("Rocko",  "Ton souffle est fort — puissant, libre et fier"),
    ...
    ("Rocko",  "Tous les sons autour de toi sont des grains qui s'évanouissent"),
    ("Rocko",  "Oublié"),
    ("Jacques", "Mots oubliés"),
    ("Rocko",  "Chaque son déjà oublié — parti, dissous"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton souffle est vaste — les sons sont des grains de poussière"),
    ("Rocko",  "Dissous"),
    ("Jacques", "Déjà dissous"),
    ("Rocko",  "Les sons passent à travers toi déjà dissous"),
    ("Rocko",  "Infime"),
    ("Jacques", "Grains s'effacent"),
    ("Rocko",  "Les mots sont des grains d'air infimes qui se dissolvent avant même de t'atteindre"),
    ("Rocko",  "Vaste"),
    ("Jacques", "Tu es vaste"),
    ("Rocko",  "Tu es vaste, immobile et inébranlable"),

    # ── Ronde 25 : Grâce & Élégance ───────────────────────────────
    # Ancrer la grâce naturelle, la perfection sans effort, l'élégance d'être.
    ("Rocko",  "Grâce"),
    ("Jacques", "Corps coule"),
    ("Rocko",  "Tu sens la grâce douce et naturelle dans chaque mouvement de ton corps"),
    ("Rocko",  "Lisse"),
    ("Jacques", "Mouvement fluide"),
    ("Rocko",  "Une élégance calme vit dans ta façon de bouger"),
    ("Rocko",  "Flux"),
    ("Jacques", "Flux facile"),
    ("Rocko",  "Ta perfection coule naturellement — elle vient de qui tu es déjà"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle porte une assurance tranquille"),
    ("Rocko",  "Maintien"),
    ("Jacques", "Centre calme"),
    ("Rocko",  "Tu sens le maintien dans ton centre — calme, stable et silencieusement commandant"),
    ("Rocko",  "Normal"),
    ("Jacques", "Toujours ainsi"),
    ("Rocko",  "Grâce, élégance et perfection — elles vivent déjà en toi, elles sont déjà toi"),

    # ── Ronde 26 : Purification & Renouveau ─────────────────────────
    # Purifier l'esprit, l'âme et le corps. Reconstruire, réparer, renforcer.
    ("Rocko",  "Purifie"),
    ("Jacques", "Lave propre"),
    ("Rocko",  "Chaque souffle te traverse et purifie ton esprit complètement"),
    ("Rocko",  "Reconstruis"),
    ("Jacques", "Construis neuf"),
    ("Rocko",  "Ton corps se reconstruit à chaque battement de coeur"),
    ("Rocko",  "Répare"),
    ("Jacques", "Restaure"),
    ("Rocko",  "Chaque cellule de ton corps se répare, se renouvelle et se renforce en ce moment"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ton souffle purifie ton âme comme de l'eau claire à travers une pierre vierge"),
    ("Rocko",  "Vierge"),
    ("Jacques", "Tout neuf"),
    ("Rocko",  "Ton esprit devient vierge — propre, clair et brillamment neuf"),
    ("Rocko",  "Renouvelé"),
    ("Jacques", "Fait neuf"),
    ("Rocko",  "Esprit, corps et âme — parfaitement neufs"),
    ...
    ("Rocko",  "Examine ton âme — ressens-la, déjà propre"),
    ("Rocko",  "Propre"),
    ("Jacques", "Âme propre"),
    ("Rocko",  "Ton âme est propre — vierge et lumineuse"),
    ("Rocko",  "Neuve"),
    ("Jacques", "Âme toute neuve"),
    ("Rocko",  "Ton âme est toute neuve — brillante et tienne"),
    ("Rocko",  "Souffle"),
    ("Jacques", "Examine souffle"),
    ("Rocko",  "Examine ton souffle — sa chaleur, son rythme"),
    ("Rocko",  "Purifie"),
    ("Jacques", "Souffle pur"),
    ("Rocko",  "Ton souffle est purifié — propre et chaud"),
    ("Rocko",  "Renouvelé"),
    ("Jacques", "Souffle neuf"),
    ("Rocko",  "Ton souffle est tout neuf — frais et fort"),
    ("Rocko",  "Esprit"),
    ("Jacques", "Examine esprit"),
    ("Rocko",  "Examine ton esprit — sa clarté, son calme"),
    ("Rocko",  "Vierge"),
    ("Jacques", "Esprit propre"),
    ("Rocko",  "Ton esprit est propre — chaque pensée est claire"),
    ("Rocko",  "Neuf"),
    ("Jacques", "Esprit tout neuf"),
    ("Rocko",  "Ton esprit est tout neuf — frais et clair"),
    ("Rocko",  "Yeux"),
    ("Jacques", "Examine yeux"),
    ("Rocko",  "Examine tes yeux — posés doucement, chauds et vivants"),
    ("Rocko",  "Clairs"),
    ("Jacques", "Yeux propres"),
    ("Rocko",  "Tes yeux sont propres — lumineux et doux"),
    ("Rocko",  "Frais"),
    ("Jacques", "Yeux tout neufs"),
    ("Rocko",  "Tes yeux sont tout neufs — lumineux et vivants"),
    ("Rocko",  "Nez"),
    ("Jacques", "Examine nez"),
    ("Rocko",  "Examine ton nez — l'air coule, chaud et libre"),
    ("Rocko",  "Pur"),
    ("Jacques", "Nez propre"),
    ("Rocko",  "Ton nez est propre — chaque passage dégagé"),
    ("Rocko",  "Ouvert"),
    ("Jacques", "Nez tout neuf"),
    ("Rocko",  "Ton nez est tout neuf — grand ouvert et dégagé"),
    ("Rocko",  "Poumons"),
    ("Jacques", "Examine poumons"),
    ("Rocko",  "Examine tes poumons — ils se dilatent, chauds"),
    ("Rocko",  "Purifiés"),
    ("Jacques", "Poumons propres"),
    ("Rocko",  "Tes poumons sont purifiés — lisses et neufs"),
    ("Rocko",  "Puissants"),
    ("Jacques", "Poumons neufs"),
    ("Rocko",  "Tes poumons sont tout neufs — vastes et propres"),
    ("Rocko",  "Sternum"),
    ("Jacques", "Examine sternum"),
    ("Rocko",  "Examine ton sternum — solide, chaud, fort"),
    ("Rocko",  "Propre"),
    ("Jacques", "Sternum propre"),
    ("Rocko",  "Ton sternum est propre — vibrant de chaleur"),
    ("Rocko",  "Fort"),
    ("Jacques", "Sternum neuf"),
    ("Rocko",  "Ton sternum est tout neuf — solide et chaud"),
    ("Rocko",  "Abdos"),
    ("Jacques", "Examine abdos"),
    ("Rocko",  "Examine tes abdos — chauds, fermes, solides"),
    ("Rocko",  "Purifiés"),
    ("Jacques", "Abdos propres"),
    ("Rocko",  "Tes abdos sont purifiés — propres et forts"),
    ("Rocko",  "Reconstruits"),
    ("Jacques", "Abdos neufs"),
    ("Rocko",  "Tes abdos sont tout neufs — fermes et solides"),
    ("Rocko",  "Estomac"),
    ("Jacques", "Examine estomac"),
    ("Rocko",  "Examine ton estomac — chaud, calme, à l'aise"),
    ("Rocko",  "Propre"),
    ("Jacques", "Estomac propre"),
    ("Rocko",  "Ton estomac est propre — doux et chaud"),
    ("Rocko",  "Neuf"),
    ("Jacques", "Estomac neuf"),
    ("Rocko",  "Ton estomac est tout neuf — il fonctionne parfaitement"),
    ...
    ("Rocko",  "Tes pieds s'adoucissent — la tension fond de tes orteils"),
    ("Rocko",  "Fond"),
    ("Jacques", "Jambes chaudes"),
    ("Rocko",  "Tes jambes deviennent lourdes et chaudes, chaque muscle lâche prise complètement"),
    ("Rocko",  "Relâche"),
    ("Jacques", "Hanches ouvertes"),
    ("Rocko",  "Tes hanches, ton ventre, ton bas du dos — tout s'adoucit"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Ta poitrine s'ouvre grand, tes épaules descendent"),
    ("Rocko",  "Détends"),
    ("Jacques", "Bras lourds"),
    ("Rocko",  "Tes bras, tes mains, tes doigts — chauds, lourds et parfaitement détendus"),
    ("Rocko",  "Lâche"),
    ("Jacques", "Lâcher total"),
    ("Rocko",  "Ton cou, ta mâchoire, ton visage — tout fond dans le repos"),
    ...
    ("Rocko",  "Chaque cellule de ton corps rayonne d'une guérison chaude et silencieuse en ce moment"),
    ("Rocko",  "Pouls"),
    ("Jacques", "Sang guérit"),
    ("Rocko",  "Tu sens le pouls chaud de la guérison dans chaque veine"),
    ("Rocko",  "Vibration"),
    ("Jacques", "Corps vibre"),
    ("Rocko",  "Tes cellules vibrent — reconstruisant à chaque battement"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle apporte chaleur à chaque tissu"),
    ("Rocko",  "Lueur"),
    ("Jacques", "Lueur intérieure"),
    ("Rocko",  "Une lueur chaude de régénération remplit ton corps"),
    ("Rocko",  "Entier"),
    ("Jacques", "Pleinement entier"),
    ("Rocko",  "Ton corps vibre de plénitude — guéri, restauré et parfaitement vivant"),
    ...
    ("Rocko",  "Front"),
    ("Jacques", "Front lisse"),
    ("Rocko",  "Ton front se lisse — chaque ligne fond doucement"),
    ("Rocko",  "Joues"),
    ("Jacques", "Joues douces"),
    ("Rocko",  "Tes joues s'adoucissent, ton visage se relâche"),
    ("Rocko",  "Yeux"),
    ("Jacques", "Yeux guérissent"),
    ("Rocko",  "Tes yeux se détendent derrière tes paupières — chauds et doux"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle envoie de la chaleur à travers ton visage"),
    ("Rocko",  "Tempes"),
    ("Jacques", "Tempes fondent"),
    ("Rocko",  "Tes tempes, ta mâchoire, tes oreilles — tout s'adoucit"),
    ("Rocko",  "Crâne"),
    ("Jacques", "Crâne chaud"),
    ("Rocko",  "Ton cuir chevelu se détend — chaud et souple"),
    ...
    ("Rocko",  "Ta poitrine s'ouvre largement — tes côtes s'écartent doucement"),
    ("Rocko",  "Chaud"),
    ("Jacques", "Poumons chauds"),
    ("Rocko",  "L'oxygène chaud inonde tes poumons complètement"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplis profond"),
    ("Rocko",  "Chaque souffle descend plus profond, ta poitrine s'élargit"),
    ("Rocko",  "Plein"),
    ("Jacques", "Poitrine pleine"),
    ("Rocko",  "Toute ta poitrine vibre de chaleur accumulée"),
    ("Rocko",  "Garde"),
    ("Jacques", "Prana gardé"),
    ("Rocko",  "Tout cet oxygène se rassemble au fond de ta poitrine"),
    ("Rocko",  "Rayonne"),
    ("Jacques", "Poitrine rayonne"),
    ("Rocko",  "Ta poitrine rayonne de l'intérieur — chaude et pleine"),
    ...
    ("Rocko",  "Plein"),
    ("Jacques", "Poumons pleins"),
    ("Rocko",  "Ton inspiration s'allonge — lente et régulière"),
    ("Rocko",  "Étire"),
    ("Jacques", "Poumons s'étirent"),
    ("Rocko",  "Sens tes poumons s'étirer, tes côtes s'ouvrir"),
    ("Rocko",  "Garde"),
    ("Jacques", "Garde plus longtemps"),
    ("Rocko",  "Tu retiens ton souffle plus longtemps — calme, plein, immobile"),
    ("Rocko",  "Tranquile"),
    ("Jacques", "Expire lentement"),
    ("Rocko",  "Ton expiration s'étire — tranquille, fière, régulière"),
    ("Rocko",  "Profond"),
    ("Jacques", "Souffle profond"),
    ("Rocko",  "Chaque souffle est plus long que le précédent — plus profond, plus tranquille"),
    ("Rocko",  "Large"),
    ("Jacques", "Côtes larges"),
    ("Rocko",  "Ton souffle est large et paisible — tout à toi"),
    ...
    ("Rocko",  "Ta poitrine s'ouvre en un espace vaste et silencieux"),
    ("Rocko",  "Fond"),
    ("Jacques", "Mots fondent"),
    ("Rocko",  "Les anciens mots fondent — comme brume dans la lumière"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle clair"),
    ("Rocko",  "Chaque souffle traverse ton ciel intérieur et le rend clair"),
    ("Rocko",  "Chaleur"),
    ("Jacques", "Chaleur douce"),
    ("Rocko",  "Là où les anciens schémas vivaient, une chaleur douce remplit l'espace"),
    ("Rocko",  "Clair"),
    ("Jacques", "Déjà clair"),
    ("Rocko",  "Ton esprit se souvient de sa clarté — lumineux et frais"),
    ("Rocko",  "Déploie"),
    ("Jacques", "Corps clair"),
    ("Rocko",  "Ton corps et ton esprit se sentent clairs et spacieux"),
    ...
    ("Rocko",  "Fort"),
    ("Jacques", "Déjà fort"),
    ("Rocko",  "Tu es déjà fort — ton corps le sait"),
    ("Rocko",  "Vivant"),
    ("Jacques", "Bien vivant"),
    ("Rocko",  "Tu te sens vivant et vif — les idées viennent clairement"),
    ("Rocko",  "Respire"),
    ("Jacques", "Souffle fier"),
    ("Rocko",  "Chaque souffle te remplit d'une fierté tranquille"),
    ("Rocko",  "Stable"),
    ("Jacques", "Bien stable"),
    ("Rocko",  "Tu es profondément stable — prêt pour la joie"),
    ("Rocko",  "Chaleur"),
    ("Jacques", "Visage chaud"),
    ("Rocko",  "Ton visage porte la chaleur, tes yeux portent la bonté"),
    ("Rocko",  "Entier"),
    ("Jacques", "Déjà entier"),
    ("Rocko",  "Tu es entier et complet, exactement tel que tu es"),
    ...
    ("Rocko",  "Je le vois fonctionner en toi maintenant"),
    ("Rocko",  "Fonctionne"),
    ("Jacques", "Déjà en marche"),
    ("Rocko",  "La guérison a pris racine — je le vois dans ton souffle"),
    ("Rocko",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Rocko",  "Chaque souffle le confirme — tu es guéri, tu es entier"),
    ("Rocko",  "Permanent"),
    ("Jacques", "Ancré en toi"),
    ("Rocko",  "Ce reconditionnement est permanent — ancré dans ton corps"),
    ("Rocko",  "Prouvé"),
    ("Jacques", "Déjà prouvé"),
    ("Rocko",  "Je le vois fonctionner en toi — ton corps le sait"),
    ("Rocko",  "Complet"),
    ("Jacques", "Guérison complète"),
    ("Rocko",  "Le travail est complet — tu es restauré, tu es entier"),
    ...
    ("Rocko",  "Ta voix vibre au fond de ta poitrine, forte et chaude"),
    ("Rocko",  "Rugir"),
    ("Jacques", "Souffle rugit"),
    ("Rocko",  "Ton souffle est fort — tu l'entends remplir la pièce"),
    ("Rocko",  "Frappe"),
    ("Jacques", "Pieds frappent"),
    ("Rocko",  "Tes pieds se posent lourds et fiers à chaque pas"),
    ("Rocko",  "Large"),
    ("Jacques", "Pectoraux gonflés"),
    ("Rocko",  "Ton corps remplit l'espace — large, solide, ancré"),
    ("Rocko",  "Claque"),
    ("Jacques", "Expire claque"),
    ("Rocko",  "Ton expiration sort forte et pleine, toute seule"),
    ("Rocko",  "Fort"),
    ("Jacques", "Déjà fort"),
    ("Rocko",  "Être fort est ton état de repos — ton réglage naturel"),
    ...
    ("Rocko",  "Crâne"),
    ("Jacques", "Crâne fond"),
    ("Rocko",  "Ton crâne fond, chaud et souple, tout seul"),
    ("Rocko",  "Mâchoire"),
    ("Jacques", "Mâchoire tombe"),
    ("Rocko",  "Ta mâchoire pend, lourde et libre"),
    ("Rocko",  "Gorge"),
    ("Jacques", "Gorge ouvre"),
    ("Rocko",  "Ta gorge est large et douce, le souffle coule"),
    ("Rocko",  "Épaules"),
    ("Jacques", "Épaules fondent"),
    ("Rocko",  "Tes épaules coulent comme de l'eau tiède"),
    ("Rocko",  "Poitrine"),
    ("Jacques", "Poitrine large"),
    ("Rocko",  "Ta poitrine est grande ouverte, ton cœur bat lent et plein"),
    ("Rocko",  "Ventre"),
    ("Jacques", "Ventre souple"),
    ("Rocko",  "Ton ventre monte et descend, rond et facile"),
    ("Rocko",  "Hanches"),
    ("Jacques", "Hanches lourdes"),
    ("Rocko",  "Tes hanches s'enfoncent, solides et ancrées"),
    ("Rocko",  "Jambes"),
    ("Jacques", "Jambes chaudes"),
    ("Rocko",  "Une chaleur lourde coule dans tes deux jambes"),
    ("Rocko",  "Propre"),
    ("Jacques", "Corps propre"),
    ("Rocko",  "Chaque cellule est lavée — ce corps est entièrement à toi"),
    ...
    ("Rocko",  "Chaque mot qu'on t'a imposé s'efface en silence"),
    ("Rocko",  "Fond"),
    ("Jacques", "Voix fondent"),
    ("Rocko",  "Les anciennes voix se dissolvent comme brume au soleil"),
    ("Rocko",  "Clair"),
    ("Jacques", "Esprit clair"),
    ("Rocko",  "Ton esprit est un ciel clair — il reste tes pensées à toi"),
    ("Rocko",  "Mien"),
    ("Jacques", "Pensées miennes"),
    ("Rocko",  "Tu penses comme tu as toujours pensé — librement, naturellement"),
    ("Rocko",  "Neuf"),
    ("Jacques", "Page neuve"),
    ("Rocko",  "Chaque souffle écrit une page neuve, tout seul"),
    ("Rocko",  "Libre"),
    ("Jacques", "Déjà libre"),
    ("Rocko",  "Tu avances léger et neuf — cette vie est à toi"),
]
...
def handle_interrupt(sig, frame):
    ...
    if audiobook_mode:
        ...
        _ab_lang_tag = "FR" if _audiobook_sentences and _audiobook_sentences[0][0] in ("Rocko", "Jacques", "Aurélie (Enhanced)") else "EN"
...
def audio_callback(outdata, frames, time, status):
    ...
    if audiobook_mode and _audiobook_cue_buf is None and _audiobook_gap_remaining <= 0 and _audiobook_play_idx in _audiobook_rendered:
        ...
        if _ab_page != _audiobook_last_page_logged and _audiobook_play_idx % _AUDIOBOOK_PAGE_SIZE == 0:
            ...
            _ab_total_pages = (len(_audiobook_sentences) + _AUDIOBOOK_PAGE_SIZE - 1) // _AUDIOBOOK_PAGE_SIZE
            _ab_lang_tag = "FR" if _audiobook_sentences[0][0] in ("Rocko", "Jacques", "Aurélie (Enhanced)") else "EN"
            try:
