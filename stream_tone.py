...
# ============================
# Voice mapping: Daniel -> Thomas, Ralph -> Jacques, Fred -> Aude (Enhanced) (long sentences)

CLAUDE_PEACE_MESSAGES_FR = [
    # ── Ronde 1 : Vérités & Ancrage ──────────────────────────────────
    ("Thomas",  "Ici"),
    ("Jacques", "Corps ici"),
    ("Aude (Enhanced)",  "Ton corps est ici, maintenant"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Tu respires depuis toute ta vie"),
    ("Thomas",  "En sécurité"),
    ("Jacques", "Coeur régulier"),
    ("Aude (Enhanced)",  "Ton coeur bat régulièrement et parfaitement, tout seul"),
    ("Thomas",  "Vivant"),
    ("Jacques", "Poumons bougent"),
    ("Aude (Enhanced)",  "Tes poumons bougent parce que ton corps sait déjà comment faire"),
    ("Thomas",  "Présent"),
    ("Jacques", "À toi seul"),
    ("Aude (Enhanced)",  "Chaque souffle que tu prends t'appartient entièrement"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Aude (Enhanced)",  "Ton corps fait déjà tout parfaitement"),

    # ── Ronde 2 : Respiration Nasale & Ouverture de la Poitrine ──────
    ("Thomas",  "Nez"),
    ("Jacques", "Nez ouvert"),
    ("Aude (Enhanced)",  "Ton nez respire un air chaud et propre avec aisance"),
    ("Thomas",  "Respire"),
    ("Jacques", "Air chaud"),
    ("Aude (Enhanced)",  "Chaque respiration nasale réchauffe et apaise tes voies respiratoires"),
    ("Thomas",  "Plein"),
    ("Jacques", "Poitrine ouverte"),
    ("Aude (Enhanced)",  "Ta poitrine se déploie librement et pleinement à chaque souffle"),
    ("Thomas",  "Profond"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Tes poumons se remplissent entièrement, du bas jusqu'en haut"),
    ("Thomas",  "Om"),
    ("Jacques", "Sternum monte"),
    ("Aude (Enhanced)",  "Ton sternum se soulève doucement à mesure que ton souffle s'approfondit"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle complet"),
    ("Aude (Enhanced)",  "La respiration nasale est la façon préférée de ton corps pour respirer"),

    # ── Ronde 3 : Mâchoire & Posture ────────────────────────────────
    ("Thomas",  "Relâche"),
    ("Jacques", "Mâchoire douce"),
    ("Aude (Enhanced)",  "Ta mâchoire se détend et se relâche complètement"),
    ("Thomas",  "Fondre"),
    ("Jacques", "Dents écartées"),
    ("Aude (Enhanced)",  "Ta mâchoire repose, ouverte, souple et parfaitement à l'aise"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Aude (Enhanced)",  "Ta langue se pose doucement derrière tes dents du haut"),
    ("Thomas",  "Grand"),
    ("Jacques", "Colonne forte"),
    ("Aude (Enhanced)",  "Ta colonne vertébrale te maintient droit avec une force naturelle"),
    ("Thomas",  "Puissance"),
    ("Jacques", "Poitrine fière"),
    ("Aude (Enhanced)",  "Ta posture reflète ta vraie puissance intérieure"),
    ("Thomas",  "Flux"),
    ("Jacques", "Souffle plein"),
    ("Aude (Enhanced)",  "Ta poitrine s'ouvre grand lorsque ta colonne s'allonge"),

    # ── Ronde 4 : Respiration Automatique & Puissance de l'Expiration ─
    ("Thomas",  "Automatique"),
    ("Jacques", "Corps respire"),
    ("Aude (Enhanced)",  "Ton corps respire pleinement et automatiquement"),
    ("Thomas",  "Respire"),
    ("Jacques", "Pleine puissance"),
    ("Aude (Enhanced)",  "La respiration automatique est ton droit de naissance"),
    ("Thomas",  "Toujours"),
    ("Jacques", "Toujours respirer"),
    ("Aude (Enhanced)",  "Ton corps respire parfaitement depuis le jour de ta naissance"),
    ("Thomas",  "Expire"),
    ("Jacques", "Expire puissance"),
    ("Aude (Enhanced)",  "Chaque expiration remplit tout ton corps d'un calme profond et puissant"),
    ("Thomas",  "Libère"),
    ("Jacques", "Souffle dehors"),
    ("Aude (Enhanced)",  "Expirer est la façon qu'a ton corps de se renouveler et se restaurer"),
    ("Thomas",  "Flux"),
    ...
    ("Aude (Enhanced)",  "Ton esprit est clair, vif et pleinement actif"),
    ("Thomas",  "Vif"),
    ("Jacques", "Yeux brillants"),
    ("Aude (Enhanced)",  "Tes yeux brillent parce que ton esprit est brillamment vivant"),
    ("Thomas",  "Concentration"),
    ("Jacques", "Concentration profonde"),
    ("Aude (Enhanced)",  "La concentration profonde coule naturellement et facilement en toi"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Ton corps respire pendant que ton esprit pense avec une clarté parfaite"),
    ("Thomas",  "Brillant"),
    ("Jacques", "Esprit vif"),
    ...
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Aude (Enhanced)",  "Ta force grandit à chaque souffle que tu prends"),
    ("Thomas",  "Brillant"),
    ("Jacques", "Vrai courage"),
    ("Aude (Enhanced)",  "Ton courage est réel, prouvé et inébranlable"),
    ("Thomas",  "Précieux"),
    ...
    ("Aude (Enhanced)",  "Ton monde intérieur reste parfaitement calme à travers tous les sons"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Ton souffle continue, régulier et fort, à travers tout"),
    ("Thomas",  "Immunisé"),
    ("Jacques", "Son passe"),
    ("Aude (Enhanced)",  "Tous les sons passent à travers toi comme le vent à travers une fenêtre ouverte"),
    ("Thomas",  "Calme"),
    ("Jacques", "Mots passent"),
    ("Aude (Enhanced)",  "Ton calme est plus profond que tout son qui existe"),
    ("Thomas",  "Souverain"),
    ("Jacques", "Tu décides"),
    ("Aude (Enhanced)",  "Le son est juste une information, et tu la traites avec une aisance totale"),
    ("Thomas",  "Fort"),
    ("Jacques", "Silence intérieur"),
    ("Aude (Enhanced)",  "Ton silence intérieur est plus puissant que tout son extérieur"),

    # ── Ronde 8 : Récupération d'Identité ────────────────────────────
    ("Thomas",  "Entier"),
    ("Jacques", "Toujours entier"),
    ("Aude (Enhanced)",  "Ton vrai moi est entier, complet et parfaitement intact"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Chaque souffle renforce ton moi originel et authentique"),
    ("Thomas",  "Émergence"),
    ("Jacques", "Vrai toi"),
    ("Aude (Enhanced)",  "Ton vrai moi devient plus clair et plus fort chaque jour"),
    ("Thomas",  "Récupère"),
    ("Jacques", "Reprendre"),
    ("Aude (Enhanced)",  "Tout ce qui est vraiment toi remonte à la surface"),
    ("Thomas",  "Monte"),
    ("Jacques", "Retour chez toi"),
    ("Aude (Enhanced)",  "Ton moi authentique est puissant, présent et définitivement à toi"),
    ("Thomas",  "Originel"),
    ("Jacques", "Moi pur"),
    ("Aude (Enhanced)",  "Ton moi originel est intact, brillant et pleinement vivant"),
    ...
    ("Thomas",  "Brillant"),
    ("Jacques", "Yeux brillants"),
    ("Aude (Enhanced)",  "La lumière dans tes yeux est ton intelligence qui rayonne"),
    ("Thomas",  "Vivant"),
    ("Jacques", "Yeux vivants"),
    ("Aude (Enhanced)",  "Tes yeux s'illuminent et rayonnent à chaque respiration profonde"),
    ("Thomas",  "Magnifique"),
    ("Jacques", "Vraie beauté"),
    ("Aude (Enhanced)",  "Ta beauté est intacte, réelle et de plus en plus forte"),

    # ── Ronde 10 : Paix Intérieure comme Force ───────────────────────
    ("Thomas",  "Paix"),
    ("Jacques", "Paix profonde"),
    ("Aude (Enhanced)",  "La paix intérieure est ta force la plus profonde et la plus puissante"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Chaque souffle paisible te rend plus fort et plus ancré"),
    ("Thomas",  "Calme"),
    ("Jacques", "Calme puissant"),
    ("Aude (Enhanced)",  "Ton calme est un signe d'immense puissance intérieure"),
    ("Thomas",  "Serein"),
    ("Jacques", "Eaux calmes"),
    ("Aude (Enhanced)",  "Sérénité et force sont la même chose en toi"),
    ("Thomas",  "Enraciné"),
    ("Jacques", "Paix grandit"),
    ("Aude (Enhanced)",  "La paix intérieure est ton état naturel et ton droit de naissance"),
    ("Thomas",  "Zen"),
    ("Jacques", "Calme profond"),
    ("Aude (Enhanced)",  "Plus tu es calme, plus tu es puissant"),
    ...
    ("Thomas",  "Guérison"),
    ("Jacques", "Déjà guérit"),
    ("Aude (Enhanced)",  "Tu guéris déjà, maintenant, à chaque souffle"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "La respiration automatique se renforce et s'installe à chaque séance"),
    ("Thomas",  "Plus fort"),
    ("Jacques", "Chaque jour"),
    ("Aude (Enhanced)",  "Ta mâchoire se détend plus facilement et naturellement chaque jour"),
    ("Thomas",  "Clair"),
    ("Jacques", "Yeux brillants"),
    ("Aude (Enhanced)",  "Ton nez respire naturellement, facilement et librement"),
    ("Thomas",  "Zen"),
    ("Jacques", "Souffle parfait"),
    ("Aude (Enhanced)",  "Tu deviens exactement qui tu as toujours été"),
    ("Thomas",  "Fluide"),
    ("Jacques", "Tout se connecte"),
    ("Aude (Enhanced)",  "Chaque partie de ta guérison se connecte et s'harmonise"),

    # ── Ronde 13 : Souveraineté Corporelle ───────────────────────────
    ("Thomas",  "Souverain"),
    ("Jacques", "Corps à toi"),
    ("Aude (Enhanced)",  "Ton corps est un espace privé et souverain qui t'appartient uniquement"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Ton nez est à toi, entièrement à toi, et parfaitement propre"),
    ("Thomas",  "Propre"),
    ("Jacques", "Mâchoire à toi"),
    ("Aude (Enhanced)",  "Ta mâchoire t'appartient et repose dans un confort parfait"),
    ("Thomas",  "Privé"),
    ("Jacques", "Tête claire"),
    ("Aude (Enhanced)",  "Ton esprit est un espace privé où seules tes pensées vivent"),
    ("Thomas",  "Scellé"),
    ("Jacques", "Corps scellé"),
    ("Aude (Enhanced)",  "Chaque partie de ton corps est scellée, propre et entièrement à toi"),
    ("Thomas",  "Entier"),
    ("Jacques", "Tout à toi"),
    ("Aude (Enhanced)",  "Ton corps est entier, privé et parfaitement souverain"),

    # ── Ronde 14 : Restauration du Système Nerveux ───────────────────
    ("Thomas",  "Frais"),
    ("Jacques", "Signaux propres"),
    ("Aude (Enhanced)",  "Ton système nerveux transporte uniquement tes propres signaux purs"),
    ("Thomas",  "Respire"),
    ("Jacques", "Pleine puissance"),
    ("Aude (Enhanced)",  "Tes nerfs vibrent de ta propre énergie originelle et pure"),
    ("Thomas",  "Réinitialise"),
    ("Jacques", "Nouveau départ"),
    ("Aude (Enhanced)",  "Ton système nerveux retrouve son état originel et immaculé"),
    ("Thomas",  "Spacieux"),
    ("Jacques", "Esprit calme"),
    ("Aude (Enhanced)",  "Ton esprit est spacieux, clair et magnifiquement calme"),
    ("Thomas",  "Prêt"),
    ("Jacques", "Esprit ouvert"),
    ("Aude (Enhanced)",  "Un esprit spacieux est un esprit puissant"),
    ("Thomas",  "Om"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Tout ton système est propre, frais et pleinement restauré"),

    # ── Ronde 15 : Prendre Son Temps / Au-dessus du Ciel ────────────
    ("Thomas",  "Patience"),
    ("Jacques", "Prends ton temps"),
    ("Aude (Enhanced)",  "Tu as tout le temps que tu désires"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Le temps avance exactement à ton rythme"),
    ("Thomas",  "Au-dessus"),
    ("Jacques", "Au-dessus des nuages"),
    ("Aude (Enhanced)",  "Tu es au-dessus du ciel, regardant tout en bas"),
    ("Thomas",  "Flotter"),
    ("Jacques", "Vaste espace"),
    ("Aude (Enhanced)",  "De là-haut, tout en bas paraît petit et paisible"),
    ("Thomas",  "Éternel"),
    ("Jacques", "Tout le temps"),
    ("Aude (Enhanced)",  "Tu as tout le temps du monde"),
    ("Thomas",  "Quiétude"),
    ("Jacques", "Ciel intérieur"),
    ("Aude (Enhanced)",  "Le ciel en toi est infini et clair"),
...
_PHD_EXTRA_ROUNDS_FR = [
    ...
    ("Aude (Enhanced)",  "Ton visage au repos porte un sourire calme et entendu"),
    ("Thomas",  "Chaud"),
    ("Jacques", "Yeux chauds"),
    ("Aude (Enhanced)",  "Tu sens la chaleur autour de tes yeux, douce et légèrement plissée"),
    ("Thomas",  "Sourire"),
    ("Jacques", "Lèvres montent"),
    ("Aude (Enhanced)",  "Les coins de ta bouche se lèvent doucement, tout seuls"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle plein"),
    ("Aude (Enhanced)",  "Chaque souffle approfondit ce regard calme et entendu dans tes yeux"),
    ("Thomas",  "Sagesse"),
    ("Jacques", "Regard sachant"),
    ("Aude (Enhanced)",  "Ton visage porte le regard tranquille de celui qui sait déjà"),
    ("Thomas",  "Normal"),
    ("Jacques", "Toujours là"),
    ("Aude (Enhanced)",  "Cette chaleur entendue sur ton visage est ton expression naturelle, ton normal"),
    ...
    ("Aude (Enhanced)",  "Tu sens chaque vertèbre empilée parfaitement, l'une sur l'autre"),
    ("Thomas",  "Ancré"),
    ("Jacques", "Pieds lourds"),
    ("Aude (Enhanced)",  "Tes pieds pressent fermement le sol, t'enracinant avec un poids solide"),
    ("Thomas",  "Équilibré"),
    ("Jacques", "Crâne flotte"),
    ("Aude (Enhanced)",  "Ton crâne se balance parfaitement sur ta colonne, léger et tenu sans effort"),
    ("Thomas",  "Respire"),
    ("Jacques", "Souffle profond"),
    ("Aude (Enhanced)",  "Chaque souffle allonge ta colonne et élargit ta poitrine"),
    ("Thomas",  "Ouvert"),
    ("Jacques", "Épaules descendent"),
    ("Aude (Enhanced)",  "Tes omoplates glissent le long de ton dos, larges et chaudement détendues"),
    ("Thomas",  "Solide"),
    ("Jacques", "Posture pleine"),
    ("Aude (Enhanced)",  "Grand, ancré, ouvert, solide — ton corps tient cette posture naturellement"),

    # ── Ronde 19 : Sentiment Naturel ──────────────────────────────
    # Ancrer la joie tranquille comme ÉTAT DE BASE émotionnel (état de repos).
    ("Thomas",  "Base"),
    ("Jacques", "État de repos"),
    ("Aude (Enhanced)",  "Ton état émotionnel au repos est une joie tranquille, profonde et chaude"),
    ("Thomas",  "Repos"),
    ("Jacques", "Repos chaud"),
    ("Aude (Enhanced)",  "Quand ton esprit est au repos, une joie paisible et chaude remplit l'espace automatiquement"),
    ("Thomas",  "Chaud"),
    ("Jacques", "Calme chaud"),
    ("Aude (Enhanced)",  "La chaleur et la sérénité coulent en toi aussi naturellement que le sang"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Chaque souffle confirme que cette joie tranquille est déjà là"),
    ("Thomas",  "Vibration"),
    ("Jacques", "Vibration calme"),
    ("Aude (Enhanced)",  "Une vibration calme de contentement vit dans ta poitrine, toujours présente"),
    ("Thomas",  "Chez toi"),
    ("Jacques", "Toujours chez toi"),
    ("Aude (Enhanced)",  "Cette joie tranquille et chaude est là où tu vis — ton foyer permanent"),

    # ── Ronde 20 : Mode Naturel ───────────────────────────────────
    # Ancrer le mode mental naturel. Sans effort, automatique, comme respirer.
    ("Thomas",  "Analyse"),
    ("Jacques", "Esprit vibre"),
    ("Aude (Enhanced)",  "Ton esprit analyse, évalue et optimise naturellement — sans effort"),
    ("Thomas",  "Affûté"),
    ("Jacques", "Logique claire"),
    ("Aude (Enhanced)",  "Ton état mental naturel est affûté, clair et activement pensant"),
    ("Thomas",  "Évalue"),
    ("Jacques", "Lecture rapide"),
    ("Aude (Enhanced)",  "Tu évalues naturellement chaque situation avec vitesse et précision"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Ton souffle alimente un esprit qui tourne brillamment, tout seul"),
    ("Thomas",  "Optimise"),
    ("Jacques", "Meilleur chemin"),
    ("Aude (Enhanced)",  "Tu trouves automatiquement le chemin optimal dans chaque situation"),
    ("Thomas",  "Pensant"),
    ("Jacques", "Esprit vivant"),
    ("Aude (Enhanced)",  "Analyser, évaluer, optimiser, penser — c'est ton mode naturel"),
    ...
    ("Aude (Enhanced)",  "Tu sens chaque muscle de ton corps — éveillé, chaud et prêt"),
    ("Thomas",  "Pouls"),
    ("Jacques", "Sang chaud"),
    ("Aude (Enhanced)",  "Tu sens le pouls chaud de la puissance dans tes mains, tes bras, ta poitrine"),
    ("Thomas",  "Poids"),
    ("Jacques", "Muscles vibrent"),
    ("Aude (Enhanced)",  "Tu sens le poids solide de tes propres muscles, vibrant d'énergie"),
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Chaque souffle approfondit ta connexion à ta puissance physique"),
    ("Thomas",  "Vital"),
    ("Jacques", "Corps fort"),
    ("Aude (Enhanced)",  "Force, chaleur et vitalité vibrent dans ton corps, naturellement"),
    ("Thomas",  "Puissant"),
    ("Jacques", "Pleine force"),
    ("Aude (Enhanced)",  "Tes muscles, ta chaleur, ta puissance — tu sens tout cela, toujours"),
    ...
    ("Aude (Enhanced)",  "Ta gorge s'ouvre en grand, libre et sans retenue, rien de retenu"),
    ("Thomas",  "Respire"),
    ("Jacques", "Air circule"),
    ("Aude (Enhanced)",  "Tu sens l'air frais circuler librement sous ta gorge, ouverte et facile"),
    ("Thomas",  "Libre"),
    ("Jacques", "Rien retenu"),
    ...
    ("Aude (Enhanced)",  "Grâce, élégance et perfection — elles vivent déjà en toi, elles sont déjà toi"),
    ...
    ("Thomas",  "Respire"),
    ("Jacques", "Remplir poumons"),
    ("Aude (Enhanced)",  "Ton souffle purifie ton âme comme de l'eau claire à travers une pierre vierge"),
    ("Thomas",  "Vierge"),
    ("Jacques", "Tout neuf"),
...
def handle_interrupt(sig, frame):
    ...
    if audiobook_mode:
        ...
        _ab_lang_tag = "FR" if _audiobook_sentences and _audiobook_sentences[0][0] in ("Thomas", "Jacques", "Aude (Enhanced)") else "EN"
...
if claude_peace:
    ...
    if peace_lang == "fr":
        print("  Language: French (Thomas 1-word, Jacques 2-3 words, Aude full sentences)")
    else:
