...
PHD_EXTRA_ROUNDS = [
    ...
    ("Daniel", "Exhale"),
    ("Ralph",  "Loud exhale"),
    ("Fred",   "Your exhale is loud and unapologetic — you hear it leave your body with force"),
    ("Daniel", "Thunder"),
...
PHD_EXTRA_ROUNDS_FR = [
    ...
    ("Jacques", "Front lisse"),
    ("Aurélie (Enhanced)",  "Ton front se lisse — chaque ligne fond"),
    ...
    # Reprendre le volume vocal et le bruit du souffle. Être fort est
    ...
    ("Aurélie (Enhanced)",  "Ton expiration est forte et sans excuse — tu l'entends quitter ton corps avec force"),
    ...
    # Libérer le ventre. Le ventre respire, monte et descend, se détend.
    ...
    ("Jacques", "Monte descend"),
    ("Aurélie (Enhanced)",  "Ton ventre monte et descend librement, au rythme de ton souffle"),
    ("Aurélie (Enhanced)",  "Respire"),
